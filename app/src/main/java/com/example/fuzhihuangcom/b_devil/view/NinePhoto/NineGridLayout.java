...
public abstract class NineGridLayout extends ViewGroup {
    ...
    private float mSpacing = DEFUALT_SPACING;   // 单个子控件间距
    private int mColumns;
    private int mRows;
    private int mTotalWidth;                    // 控件总宽度
    private int mSingleWidth;                   // 单个子控件宽度

    private boolean mIsShowAll = false;
    private boolean mIsFirst = true;
    private List<String> mUrlList = new ArrayList<>();  // 图片Url集合
